...
import 'package:sorteio_front/core/features/bolao/pages/criar_bolao_page.dart';
...
class BolaoModule extends Module {
  ...
  void routes(RouteManager r) {
    ...
    r.child('/criar', child: (context) => const CriarBolaoPage());
